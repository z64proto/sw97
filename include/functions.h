...
s32 Actor_RequestToTalkAndExchangeItemInRange(Actor* actor, GlobalContext* globalCtx, f32 arg2, f32 arg3, u32 arg4);
s32 Actor_RequestToTalkAndExchangeItem(Actor* actor, GlobalContext* globalCtx, f32 arg2, u32 arg3);
...
void Actor_SpawnFloorDust(GlobalContext* globalCtx, Actor* actor, Vec3f* arg2, f32 arg3, s32 arg4, f32 arg5, s16 arg6,
                          s16 arg7, u8 arg8);
void Actor_SpawnFlyingDust(GlobalContext* globalCtx, Vec3f* arg1, f32 arg2, s32 arg3, s16 arg4, s16 arg5, u8 arg6);
...
s32 Actor_Talk(GlobalContext* globalCtx, Actor* actor, s16* arg2, f32 arg3, u16 (*unkFunc1)(GlobalContext*, Actor*),
               s16 (*unkFunc2)(GlobalContext*, Actor*));
s16 Npc_GetSightAngleRange(s16 arg0);
void Npc_TurnTowardsFocus(Actor* actor, NpcInfo* arg1, s16 arg2, s16 arg3);
...
Gfx* Gfx_TextureCI4(Gfx* displayListHead, void* texture, void* tlut, s16 textureWidth, s16 textureHeight, s16 rectLeft,
...
s32 Player_IsTargetting(Player* player);
...
void Player_InitTargetting(Player* player);
...
s32 Player_OverrideLimbDrawImpl(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot,
                                void* data);
s32 Player_OverrideLimbDraw1(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* data);
s32 Player_OverrideLimbDraw2(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* data);
s32 Player_OverrideLimbDraw3(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* data);
u8 Player_SetQuadWeaponCollision(GlobalContext* globalCtx, ColliderQuad* collider, WeaponInfo* weaponDim, Vec3f* newTip,
                                 Vec3f* newBase);
...
// ? func_800F5CF8(?);
void func_800F5E18(s32, s32, s32, s32, s32);
...
void FileSelect_Init(GameState* thisx);    // FileSelect_Init
void FileSelect_Destroy(GameState* thisx); // FileSelect_Destroy
