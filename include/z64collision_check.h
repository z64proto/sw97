...
#define DMG_ARROW_SOUL   (1 << 0x0F)
#define DMG_ARROW_DARK   (1 << 0x10)
...
#define DMG_ARROW (DMG_ARROW_NORMAL | DMG_ARROW_FIRE | DMG_ARROW_ICE | DMG_ARROW_LIGHT | DMG_ARROW_WIND | DMG_ARROW_SOUL | DMG_ARROW_DARK)
