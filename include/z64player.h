...
typedef enum {
    ...
    /* Values below are only relevant when setting regs in Player_SetMovementBehavior */
...
typedef enum {
    ...
    /* 0x0C */ PLAYER_AP_BOW_DARK,
    /* 0x0D */ PLAYER_AP_BOW_WIND,
    /* 0x0E */ PLAYER_AP_BOW_SOUL,
    ...
    /* 0x15 */ PLAYER_AP_MAGIC_SPELL_ICE,
    /* 0x16 */ PLAYER_AP_MAGIC_SPELL_LIGHT,
    /* 0x17 */ PLAYER_AP_MAGIC_SPELL_DARK,
    ...
    /* 0x42 */ PLAYER_AP_LENS,
    /* 0x43 */ PLAYER_AP_SHIELD, // new action for holding shield only
    /* 0x44 */ PLAYER_AP_BOMB_BAG, // new action for the bomb bag
    /* 0x45 */ PLAYER_AP_MAX
} PlayerActionParam;
...
#define HAT_LIMBS 4
#define HAT_SCALE_CHILD 1.2
#define HAT_SCALE_ADULT 1.43

#define RIGHT_TURN_90_FRAMES 12.0f
#define LEFT_TURN_90_FRAMES 12.0f

#define RIGHT_TURN_180_FRAMES 12.0f
#define LEFT_TURN_180_FRAMES 12.0f

#define TURN_MINIMUM_SPEED 0.95f
