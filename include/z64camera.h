...
// Changed for SW, very speculative naming for some of these...
typedef enum {
    /* 0x00 */ CAM_SET_NONE,
    /* 0x01 */ CAM_SET_NORMAL0, // ID 0x2 in original overdump
    /* 0x02 */ CAM_SET_NORMAL1, // ID 0x3 in original overdump
    /* 0x03 */ CAM_SET_DUNGEON0, // ID 0x1E in original overdump
    /* 0x04 */ CAM_SET_DUNGEON1, // ID 0x2B in original overdump
    /* 0x05 */ CAM_SET_NORMAL3, // ID 0x5 in original overdump, this matches final's order!
    /* 0x06 */ CAM_SET_HORSE0, // Possibly ID 0x1D in the original overdump, but may have functioned differently? Very unsure.
    /* 0x07 */ CAM_SET_NORMAL5, // ID 0x7 in original overdump
    /* 0x08 */ CAM_SET_NORMAL6, // ID 0x8 in original overdump
    /* 0x09 */ CAM_SET_NORMAL7, // ID 0x9 in original overdump
    /* 0x0A */ CAM_SET_NAVI, // Made up to make Spirit Medallion spell better
    /* 0x0B */ CAM_SET_WATER, // ID 0x1F in original overdump
    /* 0x0C */ CAM_SET_LOOKUP, // ID 0x21 in original overdump
    /* 0x0D */ CAM_SET_BRIDGE, // ID 0x28 in original overdump
    /* 0x0E */ CAM_SET_TUNNEL, // ID 0x29 in original overdump
    /* 0x0F */ CAM_SET_STAIRS, // ID 0x2A in original overdump
    /* 0x10 */ CAM_SET_SASA, // ID 0xF in original overdump
    /* 0x11 */ CAM_SET_BOSS_GANON2,
    /* 0x12 */ CAM_SET_TOWER0, // ID 0x16 in original overdump
    /* 0x13 */ CAM_SET_TOWER1,
    /* 0x14 */ CAM_SET_FIXED0,
    /* 0x15 */ CAM_SET_FIXED1,
    /* 0x16 */ CAM_SET_CIRCLE0,
    /* 0x17 */ CAM_SET_CIRCLE2,
    /* 0x18 */ CAM_SET_CIRCLE3, // ID 0xE in original overdump
    /* 0x19 */ CAM_SET_PREREND0, // ID 0x12 in original overdump
    /* 0x1A */ CAM_SET_PREREND1, // ID 0x13 in original overdump
    /* 0x1B */ CAM_SET_PREREND3,
    /* 0x1C */ CAM_SET_DOOR0, // ID 0x14 in original overdump
    /* 0x1D */ CAM_SET_DOORC, // Possibly ID 0x15 in original overdump
    /* 0x1E */ CAM_SET_RAIL3, // Possibly ID 0x27 in original overdump
    /* 0x1F */ CAM_SET_START0,
    /* 0x20 */ CAM_SET_START1,
    /* 0x21 */ CAM_SET_FREE0,
    /* 0x22 */ CAM_SET_FREE2,
    ...
    /* 0x3A */ CAM_SET_NORMAL2, // ID 0x4 in original overdump
    /* 0x3B */ CAM_SET_FISHING,
    /* 0x3C */ CAM_SET_DEMOC,
    /* 0x3D */ CAM_SET_UO_FIBER,
    /* 0x3E */ CAM_SET_DUNGEON2, // Possibly ID 0x2C in original overdump
    /* 0x3F */ CAM_SET_TEPPEN,
    /* 0x40 */ CAM_SET_CIRCLE7,
    /* 0x41 */ CAM_SET_NORMAL4, // ID 0x6 in original overdump
    /* 0x42 */ CAM_SET_MAX
} CameraSettingType;
