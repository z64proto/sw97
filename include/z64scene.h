...
typedef enum {
    ...
    /* 0x02 */ SCENE_OLD_SYOTES,
    /* 0x03 */ SCENE_OLD_SYOTES2,
    /* 0x04 */ SCENE_UNKNOWN_TEST_MAP,
    /* 0x05 */ SCENE_UNFINISHED_DEKU_TREE,
    /* 0x06 */ SCENE_UNFINISHED_GOHMA,
    /* 0x07 */ SCENE_OLD_DEPTH_TEST,
    /* 0x08 */ SCENE_I_SHOP,
    /* 0x09 */ SCENE_HYRULE_FIELD,
    /* 0x0A */ SCENE_OLD_KAKARIKO_VILLAGE,
    /* 0x0B */ SCENE_OLD_GRAVEYARD,
    /* 0x0C */ SCENE_OLD_LOST_WOODS,
    /* 0x0D */ SCENE_KOKIRI_FOREST,
    /* 0x0E */ SCENE_OLD_FOREST_MEADOW,
    /* 0x0F */ SCENE_OLD_LAKE_HYLIA,
    /* 0x10 */ SCENE_OLD_ZORAS_RIVER,
    /* 0x11 */ SCENE_OLD_POND,
    /* 0x12 */ SCENE_GERUDO_VALLEY,
    /* 0x13 */ SCENE_HYRULE_CASTLE,
    /* 0x14 */ SCENE_DEATH_MOUNTAIN_TRAIL,
    /* 0x15 */ SCENE_DEATH_MOUNTAIN_CRATER,
    /* 0x16 */ SCENE_UNK_0x16, // weird cave?
    /* 0x17 */ SCENE_UNK_0x17, // goron city?
    /* 0x18 */ SCENE_PR_MARKET_1,
    /* 0x19 */ SCENE_PR_MARKET_2,
    /* 0x1A */ SCENE_FIRE_TEMPLE,
    /* 0x1B */ SCENE_FOREST_TEMPLE,
    /* 0x1C */ SCENE_OLD_ARCHERY,
    /* 0x1D */ SCENE_OLD_SASATEST,
    /* 0x1E */ SCENE_PR_BEHIND_TOT,
    /* 0x1F */ SCENE_OLD_TESTROOM,
    /* 0x20 */ SCENE_DEKU_TREE,
    /* 0x21 */ SCENE_JABU_TEST,
    /* 0x22 */ SCENE_CHAMBER_OF_SAGES,
    /* 0x23 */ SCENE_PR_OUTSIDE_TOT,
    /* 0x24 */ SCENE_FAIRY_FOUNTAIN,
    /* 0x25 */ SCENE_TEMPLE_OF_TIME,
    /* 0x26 */ SCENE_UNFINISHED_FOREST_TEMPLE,
    /* 0x27 */ SCENE_LOD_TEST,
    /* 0x28 */ SCENE_OLD_SUTARU,
    /* 0x29 */ SCENE_UNFINISHED_FIRE_TEMPLE,
    /* 0x2A */ SCENE_PR_LINKS_HOUSE,
    /* 0x2B */ SCENE_PR_KOKIRI_HOUSE_1,
    /* 0x2C */ SCENE_UNK_0x2C,
    /* 0x2D */ SCENE_OLD_HYRULE_FIELD,
    /* 0x2E */ SCENE_UNK_0x2E, // watery cave?
    /* 0x2F */ SCENE_WATER_TEMPLE,
    /* 0x30 */ SCENE_PR_KOKIRI_HOUSE_2,
    /* 0x31 */ SCENE_GROTTOS,
    /* 0x32 */ SCENE_SPECIAL_COURSE,
    /* 0x33 */ SCENE_UNK_0x33, // broken?
    /* 0x04 */ SCENE_SPOT04_OLD,
    /* 0x35 */ SCENE_SPACEWORLD_MAX
} SceneID;

typedef enum {
    /* 0x00 */ SCENE_YDAN = 0x80, // disable hardcoded scene checks if possible
    /* 0x01 */ SCENE_DDAN,
    /* 0x02 */ SCENE_BDAN,
    /* 0x03 */ SCENE_BMORI1,
    /* 0x04 */ SCENE_HIDAN,
