...
char sCameraSettingNames[][12] = {
    ...
    "NORMAL5    ", "NORMAL6    ", "NORMAL7    ", "NAVI       ", "WATER      ", "LOOKUP     ", "BRIDGE     ",
    "TUNNEL     ", "STAIRS     ", "SASA       ", "GANON2     ", "TOWER0     ", "TOWER1     ", "FIXED0     ",
...
CameraModeValue sSetNorm0ModeNormVals[] = {
    /* CAM_FUNC_NORM1 */
    { -20, 0 },    // yOffset
    { 200, 1 },    // distMin
    { 300, 2 },    // distMax
...
CameraModeValue sSetNorm3ModeNormVals[] = {
    ...
    { 150, 2 },    // distMax
    { 13, 3 },     // pitchTarget
    { 12, 4 },     // unk_0C (Swing update rate)
    { 20, 5 },     // unk_10 (Slope pitch adjust rate?)
    { 40, 6 },     // unk_14 (Yaw adjust rate?)
    { 60, 7 },     // fovTarget
    { 60, 8 },     // atLERPScaleMax
    { 0x0003, 9 }, // flags
};

CameraModeValue sSetNorm3ModeTargetVals[] = {
    /* CAM_FUNC_PARA1 */
    { -40, 0 },    // unk_00
    { 200, 1 },    // distTarget
    { 0, 3 },      // pitchTarget
...
CameraModeValue sSetNorm4ModeNormVals[] = {
    /* CAM_FUNC_NORM1 */
    { -20, 0 },    // yOffset
    { 150, 1 },    // distMin
    { 200, 2 },    // distMax
...
CameraModeValue sSetNorm4ModeTargetVals[] = {
    /* CAM_FUNC_PARA1 */
    { -20, 0 },    // unk_00
    { 200, 1 },    // distTarget
    { 0, 3 },      // pitchTarget
...
CameraModeValue sSetNorm5ModeNormVals[] = {
    /* CAM_FUNC_NORM1 */
    { -30, 0 },    // yOffset
    { 150, 1 },    // distMin
    { 250, 2 },    // distMax
...
CameraModeValue sSetNorm5ModeTargetVals[] = {
    /* CAM_FUNC_PARA1 */
    { -30, 0 },    // unk_00
    { 250, 1 },    // distTarget
    { 0, 3 },      // pitchTarget
...
CameraModeValue sSetNorm6ModeNormVals[] = {
    /* CAM_FUNC_NORM1 */
    { -20, 0 },    // yOffset
    { 300, 1 },    // distMin
    { 500, 2 },    // distMax
...
CameraModeValue sSetNorm6ModeTargetVals[] = {
    /* CAM_FUNC_PARA1 */
    { 0, 0 },      // unk_00
    { 250, 1 },    // distTarget
    { 0, 3 },      // pitchTarget
...
CameraModeValue sSetNorm7ModeNormVals[] = {
    /* CAM_FUNC_NORM1 */
    { -10, 0 },    // yOffset
    { 150, 1 },    // distMin
    { 250, 2 },    // distMax
...
CameraModeValue sDungeon0ModeNormVals[] = {
    /* CAM_FUNC_NORM1 */
    { -10, 0 },    // yOffset
    { 150, 1 },    // distMin
    { 250, 2 },    // distMax
...
CameraModeValue sDungeon1ModeNormVals[] = {
    /* CAM_FUNC_NORM1 */
    { -20, 0 },    // yOffset
    { 100, 1 },    // distMin
    { 150, 2 },    // distMax
...
CameraModeValue sDungeon1ModeTargetVals[] = {
    /* CAM_FUNC_PARA1 */
    { -20, 0 },    // unk_00
    { 200, 1 },    // distTarget
    { 0, 3 },      // pitchTarget
...
CameraModeValue sLookUpModeNormVals[] = {
    /* CAM_FUNC_NORM1 */
    { 10, 0 },      // yOffset
    { 150, 1 },    // distMin
    { 250, 2 },    // distMax
...
CameraModeValue sTunnelModeNormVals[] = {
    /* CAM_FUNC_NORM1 */
    { -20, 0 },    // yOffset
    { 150, 1 },    // distMin
    { 200, 2 },    // distMax
...
CameraModeValue sSetSasaModeNormVals[] = {
    /* CAM_FUNC_NORM1 */
    { -20, 0 },    // yOffset
    { 300, 1 },    // distMin
    { 500, 2 },    // distMax
...
CameraModeValue sStairsModeNormVals[] = {
    /* CAM_FUNC_NORM1 */
    { -10, 0 },    // yOffset
    { 200, 1 },    // distMin
    { 300, 2 },    // distMax
...
CameraModeValue sNaviModeNormVals[] = {
    /* CAM_FUNC_NORM1 */
    { -65, 0 },    // yOffset
    { 80, 1 },     // distMin
    { 150, 2 },    // distMax
...
CameraModeValue sNaviModeTargetVals[] = {
    /* CAM_FUNC_PARA1 */
    { -80, 0 },    // unk_00
    { 120, 1 },    // distTarget
    { 0, 3 },      // pitchTarget
...
CameraModeValue sWaterModeNormVals[] = {
    /* CAM_FUNC_NORM1 */
    { -20, 0 },    // yOffset
    { 200, 1 },    // distMin
    { 300, 2 },    // distMax
...
CameraModeValue sGenericModeTargetVals0[] = {
    /* CAM_FUNC_PARA1 */
    { -20, 0 },    // unk_00
    { 250, 1 },    // distTarget
    { 0, 3 },      // pitchTarget
...
CameraModeValue sGenericModeFollowTargetVals0[] = {
    /* CAM_FUNC_KEEP1 */
    { -20, 0 },    // unk_00
    { 120, 1 },    // unk_04
    { 140, 2 },    // unk_08
...
CameraModeValue sGenericModeTalkVals0[] = {
    /* CAM_FUNC_KEEP3 */
    { -30, 0 },    // yOffset
    { 70, 1 },     // minDist
    { 200, 2 },    // maxDist
...
CameraModeValue sGenericModeClimbVals0[] = {
    /* CAM_FUNC_JUMP2 */
    { -20, 0 },    // atYOffset
    { 200, 1 },    // minDist
    { 300, 2 },    // maxDist
...
CameraModeValue sGenericModeFPVals0[] = {
    /* CAM_FUNC_SUBJ3 */
    { 0, 0 },      // eyeNextYOffset
    { 5, 1 },      // eyeDist
    { 50, 2 },     // eyeNextDist
...
CameraModeValue sGenericModeBowVals0[] = {
    /* CAM_FUNC_SUBJ3 */
    { -7, 0 },     // eyeNextYOffset
    { 14, 1 },     // eyeDist
    { 50, 2 },     // eyeNextDist
...
CameraModeValue sGenericModeBowZVals0[] = {
    /* CAM_FUNC_SUBJ3 */
    { 20, 0 },     // eyeNextYOffset
    { 70, 1 },     // eyeDist
    { 70, 2 },     // eyeNextDist
...
CameraModeValue sGenericModeHookshotVals1[] = {
    /* CAM_FUNC_SPEC5 */
    { -20, 0 },    // yOffset
    { 80, 1 },     // eyeDist
    { 250, 2 },    // minDistForRot
...
CameraModeValue sGenericModeBoomerangVals0[] = {
    /* CAM_FUNC_SUBJ3 */
    { 5, 0 },      // eyeNextYOffset
    { 50, 1 },     // eyeDist
    { 50, 2 },     // eyeNextDist
...
CameraModeValue sGenericModeSlingshotVals0[] = {
    /* CAM_FUNC_SUBJ3 */
    { -7, 0 },     // eyeNextYOffset
    { 14, 1 },     // eyeDist
    { 50, 2 },     // eyeNextDist
...
CameraModeValue sGenericModeClimbZVals0[] = {
    /* CAM_FUNC_JUMP2 */
    { -20, 0 },    // atYOffset
    { 200, 1 },    // minDist
    { 300, 2 },    // maxDist
...
CameraModeValue sGenericModeJumpVals0[] = {
    /* CAM_FUNC_JUMP1 */
    { -20, 0 },    // atYOffset
    { 200, 1 },    // distMin
    { 300, 2 },    // distMax
...
CameraModeValue sGenericModeHangVals0[] = {
    /* CAM_FUNC_UNIQ1 */
    { -80, 0 },    // yOffset
    { 200, 1 },    // distMin
    { 300, 2 },    // distMax
...
CameraModeValue sGenericModeHangZVals0[] = {
    /* CAM_FUNC_UNIQ1 */
    { -120, 0 },   // yOffset
    { 300, 1 },    // distMin
    { 300, 2 },    // distMax
...
CameraModeValue sSetNorm0ModeFreefallVals[] = {
    /* CAM_FUNC_JUMP1 */
    { -20, 0 },    // atYOffset
    { 200, 1 },    // distMin
    { 300, 2 },    // distMax
...
CameraModeValue sGenericModeChargeVals0[] = {
    /* CAM_FUNC_BATT4 */
    { -20, 0 },    // yOffset
    { 300, 1 },    // rTarget
    { 50, 3 },     // pitchTarget
...
CameraModeValue sGenericModeStillVals0[] = {
    /* CAM_FUNC_NORM1 */
    { -20, 0 },    // yOffset
    { 200, 1 },    // distMin
    { 300, 2 },    // distMax
...
CameraModeValue sGenericModePushPullVals0[] = {
    /* CAM_FUNC_PARA1 */
    { 0, 0 },      // unk_00
    { 250, 1 },    // distTarget
    { 25, 3 },     // pitchTarget
...
CameraModeValue sGenericModeBoomFollowVals0[] = {
    /* CAM_FUNC_KEEP1 */
    { -5, 0 },     // unk_00
    { 120, 1 },    // unk_04
    { 140, 2 },    // unk_08
...
CameraModeValue sGenericModeFollowTargetVals1[] = {
    /* CAM_FUNC_KEEP1 */
    { -20, 0 },    // unk_00
    { 120, 1 },    // unk_04
    { 140, 2 },    // unk_08
...
CameraModeValue sGenericModeHookshotVals0[] = {
    /* CAM_FUNC_SPEC5 */
    { -20, 0 },    // yOffset
    { 80, 1 },     // eyeDist
    { 250, 2 },    // minDistForRot
...
CameraModeValue sGenericModeJumpVals2[] = {
    /* CAM_FUNC_JUMP1 */
    { 0, 0 },      // atYOffset
    { 250, 1 },    // distMin
    { 400, 2 },    // distMax
...
CameraModeValue sGenericModeFreefallVals0[] = {
    /* CAM_FUNC_JUMP1 */
    { 0, 0 },      // atYOffset
    { 200, 1 },    // distMin
    { 400, 2 },    // distMax
...
CameraModeValue sGenericModeClimbVals2[] = {
    /* CAM_FUNC_JUMP2 */
    { -20, 0 },    // atYOffset
    { 200, 1 },    // minDist
    { 400, 2 },    // maxDist
...
CameraModeValue sGenericModeClimbZVals2[] = {
    /* CAM_FUNC_JUMP2 */
    { -20, 0 },    // atYOffset
    { 250, 1 },    // minDist
    { 400, 2 },    // maxDist
...
CameraModeValue sGenericModeChargeVals1[] = {
    /* CAM_FUNC_BATT4 */
    { 0, 0 },      // yOffset
    { 300, 1 },    // rTarget
    { 50, 3 },     // pitchTarget
...
CameraModeValue sBridgeModeHangVals[] = {
    /* CAM_FUNC_UNIQ1 */
    { -200, 0 },   // yOffset
    { 200, 1 },    // distMin
    { 400, 2 },    // distMax
...
CameraModeValue sGenericModeHangZVals1[] = {
    /* CAM_FUNC_UNIQ1 */
    { -120, 0 },   // yOffset
    { 400, 1 },    // distMin
    { 400, 2 },    // distMax
...
CameraModeValue sGenericModeStillVals1[] = {
    /* CAM_FUNC_NORM1 */
    { 0, 0 },      // yOffset
    { 200, 1 },    // distMin
    { 400, 2 },    // distMax
...
CameraModeValue sGenericModeTargetVals1[] = {
    /* CAM_FUNC_PARA1 */
    { -20, 0 },    // unk_00
    { 150, 1 },    // distTarget
    { 0, 3 },      // pitchTarget
...
CameraModeValue sGenericModeBattleVals0[] = {
    /* CAM_FUNC_BATT1 */
    { 0, 0 },      // yOffset (PCT)
    { 200, 1 },    // distance
...
CameraModeValue sGenericModeBattleVals1[] = {
    /* CAM_FUNC_BATT1  */
    { 0, 0 },      // yOffset (PCT)
    { 250, 1 },    // distance
    { 10, 13 },    // swingYawInitial
...
CameraModeValue sGenericModeBattleVals2[] = {
    /* CAM_FUNC_BATT1 */
    { -20, 0 },    // yOffset (PCT)
    { 200, 1 },    // distance
    { 10, 13 },    // swingYawInitial
...
CameraModeValue sGenericModeJumpVals1[] = {
    /* CAM_FUNC_JUMP1 */
    { -10, 0 },    // atYOffset
    { 150, 1 },    // distMin
    { 250, 2 },    // distMax
...
CameraModeValue sGenericModeClimbVals1[] = {
    /* CAM_FUNC_JUMP2 */
    { -40, 0 },    // atYOffset
    { 150, 1 },    // minDist
    { 250, 2 },    // maxDist
...
CameraModeValue sGenericModeClimbZVals1[] = {
    /* CAM_FUNC_JUMP2 */
    { -40, 0 },    // atYOffset
    { 250, 1 },    // minDist
    { 250, 2 },    // maxDist
...
CameraModeValue sSetHrse0ModeTargetVals[] = {
    /* CAM_FUNC_NORM3 */
    { -40, 0 },    // yOffset
    { 180, 1 },    // distMin
    { 220, 2 },    // distMax
...
CameraModeValue sBridgeModeNormVals[] = {
    /* CAM_FUNC_NORM1 */
    { -20, 0 },    // yOffset
    { 250, 1 },    // distMin
    { 400, 2 },    // distMax
...
/*start here */
CameraModeValue sTower0ModeNormVals[] = {
    /* CAM_FUNC_NORM2 */
    { 0, 0 },      // unk_00
    { 270, 1 },    // unk_04
    { 300, 2 },    // unk_08
...
CameraModeValue sTower0ModeJumpVals[] = {
    /* CAM_FUNC_NORM2 */
    { 0, 0 },      // unk_00
    { 270, 1 },    // unk_04
    { 300, 2 },    // unk_08
...
// Changed doors to not fade the whole interface for Spaceworld
...
CameraMode sCamSetNorm0Modes[] = {
    { CAM_FUNC_NORM1, 10, sSetNorm0ModeNormVals },         // CAM_MODE_NORMAL
    { CAM_FUNC_PARA1, 11, sGenericModeTargetVals0 },       // CAM_MODE_TARGET
    { CAM_FUNC_KEEP1, 13, sGenericModeFollowTargetVals0 }, // CAM_MODE_FOLLOWTARGET
    { CAM_FUNC_KEEP3, 12, sGenericModeTalkVals0 },         // CAM_MODE_TALK
    { CAM_FUNC_BATT1, 12, sGenericModeBattleVals0 },       // CAM_MODE_BATTLE
    { CAM_FUNC_JUMP2, 9, sGenericModeClimbVals0 },         // CAM_MODE_CLIMB
    { CAM_FUNC_SUBJ3, 9, sGenericModeFPVals0 },            // CAM_MODE_FIRSTPERSON
    { CAM_FUNC_SUBJ3, 9, sGenericModeBowVals0 },           // CAM_MODE_BOWARROW
    { CAM_FUNC_SUBJ3, 9, sGenericModeBowZVals0 },          // CAM_MODE_BOWARROWZ
    { CAM_FUNC_SPEC5, 8, sGenericModeHookshotVals1 },      // CAM_MODE_FOOKSHOT
    { CAM_FUNC_SUBJ3, 9, sGenericModeBoomerangVals0 },     // CAM_MODE_BOOMERANG
    { CAM_FUNC_SUBJ3, 9, sGenericModeSlingshotVals0 },     // CAM_MODE_SLINGSHOT
    { CAM_FUNC_JUMP2, 9, sGenericModeClimbZVals0 },        // CAM_MODE_CLIMBZ
    { CAM_FUNC_JUMP1, 8, sGenericModeJumpVals0 },          // CAM_MODE_JUMP
    { CAM_FUNC_UNIQ1, 7, sGenericModeHangVals0 },          // CAM_MODE_HANG
    { CAM_FUNC_UNIQ1, 7, sGenericModeHangZVals0 },         // CAM_MODE_HANGZ
    { CAM_FUNC_JUMP1, 8, sSetNorm0ModeFreefallVals },      // CAM_MODE_FREEFALL
    { CAM_FUNC_BATT4, 7, sGenericModeChargeVals0 },        // CAM_MODE_CHARGE
    { CAM_FUNC_NORM1, 10, sGenericModeStillVals0 },        // CAM_MODE_STILL
    { CAM_FUNC_PARA1, 11, sGenericModePushPullVals0 },     // CAM_MODE_PUSHPULL
    { CAM_FUNC_KEEP1, 13, sGenericModeBoomFollowVals0 },   // CAM_MODE_BOOMFOLLLOW
};

// CAM_SET_NORMAL3
CameraMode sCamSetNorm3Modes[] = {
    { CAM_FUNC_NORM1, 10, sSetNorm3ModeNormVals },         // CAM_MODE_NORMAL
    { CAM_FUNC_PARA1, 11, sSetNorm3ModeTargetVals },       // CAM_MODE_TARGET
    { CAM_FUNC_KEEP1, 13, sGenericModeFollowTargetVals0 }, // CAM_MODE_FOLLOWTARGET
    { CAM_FUNC_KEEP3, 12, sGenericModeTalkVals0 },         // CAM_MODE_TALK
    { CAM_FUNC_BATT1, 12, sGenericModeBattleVals2 },       // CAM_MODE_BATTLE
    { CAM_FUNC_JUMP2, 9, sGenericModeClimbVals0 },         // CAM_MODE_CLIMB
    { CAM_FUNC_SUBJ3, 9, sGenericModeFPVals0 },            // CAM_MODE_FIRSTPERSON
    { CAM_FUNC_SUBJ3, 9, sGenericModeBowVals0 },           // CAM_MODE_BOWARROW
    { CAM_FUNC_SUBJ3, 9, sGenericModeBowZVals0 },          // CAM_MODE_BOWARROWZ
    ...
    { CAM_FUNC_UNIQ1, 7, sGenericModeHangVals0 },          // CAM_MODE_HANG
    { CAM_FUNC_UNIQ1, 7, sGenericModeHangZVals0 },         // CAM_MODE_HANGZ
    { CAM_FUNC_JUMP1, 8, sGenericModeJumpVals0 },          // CAM_MODE_FREEFALL
    { CAM_FUNC_BATT4, 7, sGenericModeChargeVals0 },        // CAM_MODE_CHARGE
    { CAM_FUNC_NORM1, 10, sGenericModeStillVals0 },        // CAM_MODE_STILL
    { CAM_FUNC_PARA1, 11, sGenericModePushPullVals0 },     // CAM_MODE_PUSHPULL
    { CAM_FUNC_KEEP1, 13, sGenericModeBoomFollowVals0 },   // CAM_MODE_BOOMFOLLLOW
...
CameraMode sCamSetNorm4Modes[] = {
    { CAM_FUNC_NORM1, 10, sSetNorm4ModeNormVals },         // CAM_MODE_NORMAL
    { CAM_FUNC_PARA1, 11, sSetNorm4ModeTargetVals },       // CAM_MODE_TARGET
    { CAM_FUNC_KEEP1, 13, sGenericModeFollowTargetVals0 }, // CAM_MODE_FOLLOWTARGET
    { CAM_FUNC_KEEP3, 12, D_8011BB54 },                    // CAM_MODE_TALK
    { CAM_FUNC_BATT1, 12, sGenericModeBattleVals1 },       // CAM_MODE_BATTLE
    { CAM_FUNC_JUMP2, 9, sGenericModeClimbVals0 },         // CAM_MODE_CLIMB
    { CAM_FUNC_SUBJ3, 9, sGenericModeFPVals0 },            // CAM_MODE_FIRSTPERSON
    { CAM_FUNC_SUBJ3, 9, sGenericModeBowVals0 },           // CAM_MODE_BOWARROW
    { CAM_FUNC_SUBJ3, 9, sGenericModeBowZVals0 },          // CAM_MODE_BOWARROWZ
...
// CAM_SET_NORMAL5
CameraMode sCamSetNorm5Modes[] = {
    { CAM_FUNC_NORM1, 10, sSetNorm5ModeNormVals },         // CAM_MODE_NORMAL
    { CAM_FUNC_PARA1, 11, sSetNorm5ModeTargetVals },       // CAM_MODE_TARGET
    { CAM_FUNC_KEEP1, 13, sGenericModeFollowTargetVals0 }, // CAM_MODE_FOLLOWTARGET
    { CAM_FUNC_KEEP3, 12, sGenericModeTalkVals0 },         // CAM_MODE_TALK
    { CAM_FUNC_BATT1, 12, sGenericModeBattleVals0 },       // CAM_MODE_BATTLE
    { CAM_FUNC_JUMP2, 9, sGenericModeClimbVals0 },         // CAM_MODE_CLIMB
...
// CAM_SET_NORMAL6
CameraMode sCamSetNorm6Modes[] = {
    { CAM_FUNC_NORM1, 10, sSetNorm6ModeNormVals },         // CAM_MODE_NORMAL
    { CAM_FUNC_PARA1, 11, sGenericModeTargetVals0 },       // CAM_MODE_TARGET
    { CAM_FUNC_KEEP1, 13, sGenericModeFollowTargetVals0 }, // CAM_MODE_FOLLOWTARGET
    { CAM_FUNC_KEEP3, 12, sGenericModeTalkVals0 },         // CAM_MODE_TALK
    { CAM_FUNC_BATT1, 12, sGenericModeBattleVals0 },       // CAM_MODE_BATTLE
...
// CAM_SET_NORMAL7
CameraMode sCamSetNorm7Modes[] = {
    { CAM_FUNC_NORM1, 10, sSetNorm7ModeNormVals },         // CAM_MODE_NORMAL
    { CAM_FUNC_PARA1, 11, sGenericModeTargetVals1 },       // CAM_MODE_TARGET
    { CAM_FUNC_KEEP1, 13, sGenericModeFollowTargetVals0 }, // CAM_MODE_FOLLOWTARGET
    { CAM_FUNC_KEEP3, 12, sGenericModeTalkVals0 },         // CAM_MODE_TALK
    { CAM_FUNC_BATT1, 12, sGenericModeBattleVals2 },       // CAM_MODE_BATTLE
    { CAM_FUNC_JUMP2, 9, sGenericModeClimbVals1 },         // CAM_MODE_CLIMB
    { CAM_FUNC_SUBJ3, 9, sGenericModeFPVals0 },            // CAM_MODE_FIRSTPERSON
    { CAM_FUNC_SUBJ3, 9, sGenericModeBowVals0 },           // CAM_MODE_BOWARROW
    { CAM_FUNC_SUBJ3, 9, sGenericModeBowZVals0 },          // CAM_MODE_BOWARROWZ
    { CAM_FUNC_SPEC5, 8, sGenericModeHookshotVals0 },      // CAM_MODE_FOOKSHOT
    { CAM_FUNC_SUBJ3, 9, sGenericModeBoomerangVals0 },     // CAM_MODE_BOOMERANG
    { CAM_FUNC_SUBJ3, 9, sGenericModeSlingshotVals0 },     // CAM_MODE_SLINGSHOT
    { CAM_FUNC_JUMP2, 9, sGenericModeClimbZVals1 },        // CAM_MODE_CLIMBZ
    { CAM_FUNC_JUMP1, 8, sGenericModeJumpVals1 },          // CAM_MODE_JUMP
...
CameraMode sCamSetNaviModes[] = {
    { CAM_FUNC_NORM1, 10, sNaviModeNormVals },             // CAM_MODE_NORMAL
    { CAM_FUNC_PARA1, 11, sNaviModeTargetVals },           // CAM_MODE_TARGET
    { CAM_FUNC_KEEP1, 13, sGenericModeFollowTargetVals0 }, // CAM_MODE_FOLLOWTARGET
    { CAM_FUNC_KEEP3, 12, sGenericModeTalkVals0 },         // CAM_MODE_TALK
    { CAM_FUNC_BATT1, 12, sGenericModeBattleVals0 },       // CAM_MODE_BATTLE
    { CAM_FUNC_JUMP2, 9, sGenericModeClimbVals0 },         // CAM_MODE_CLIMB
...
// CAM_SET_WATER
CameraMode sCamSetWaterModes[] = {
    { CAM_FUNC_NORM1, 10, sWaterModeNormVals },            // CAM_MODE_NORMAL
    { CAM_FUNC_PARA1, 11, sGenericModeTargetVals0 },       // CAM_MODE_TARGET
    { CAM_FUNC_KEEP1, 13, sGenericModeFollowTargetVals0 }, // CAM_MODE_FOLLOWTARGET
    { CAM_FUNC_KEEP3, 12, sGenericModeTalkVals0 },         // CAM_MODE_TALK
    { CAM_FUNC_BATT1, 12, sGenericModeBattleVals0 },       // CAM_MODE_BATTLE
...
CameraMode sCamSetLookUpModes[] = {
    { CAM_FUNC_NORM1, 10, sLookUpModeNormVals },           // CAM_MODE_NORMAL
    { CAM_FUNC_PARA1, 11, sGenericModeTargetVals0 },       // CAM_MODE_TARGET
    { CAM_FUNC_KEEP1, 13, sGenericModeFollowTargetVals0 }, // CAM_MODE_FOLLOWTARGET
    { CAM_FUNC_KEEP3, 12, sGenericModeTalkVals0 },         // CAM_MODE_TALK
    { CAM_FUNC_BATT1, 12, sGenericModeBattleVals0 },       // CAM_MODE_BATTLE
...
CameraMode sCamSetBridgeModes[] = {
    { CAM_FUNC_NORM1, 10, sBridgeModeNormVals },           // CAM_MODE_NORMAL
    { CAM_FUNC_PARA1, 11, sGenericModeTargetVals0 },       // CAM_MODE_TARGET
    { CAM_FUNC_KEEP1, 13, sGenericModeFollowTargetVals0 }, // CAM_MODE_FOLLOWTARGET
    { CAM_FUNC_KEEP3, 12, sGenericModeTalkVals0 },         // CAM_MODE_TALK
    { CAM_FUNC_BATT1, 12, sGenericModeBattleVals0 },       // CAM_MODE_BATTLE
    ...
    { CAM_FUNC_JUMP2, 9, sGenericModeClimbZVals0 },        // CAM_MODE_CLIMBZ
    { CAM_FUNC_JUMP1, 8, sGenericModeJumpVals0 },          // CAM_MODE_JUMP
    { CAM_FUNC_UNIQ1, 7, sBridgeModeHangVals },            // CAM_MODE_HANG
    { CAM_FUNC_UNIQ1, 7, sGenericModeHangZVals0 },         // CAM_MODE_HANGZ
    { CAM_FUNC_JUMP1, 8, sGenericModeJumpVals0 },          // CAM_MODE_FREEFAL
    { CAM_FUNC_BATT4, 7, sGenericModeChargeVals0 },        // CAM_MODE_CHARGE
    { CAM_FUNC_NORM1, 10, sGenericModeStillVals0 },        // CAM_MODE_STILL
    { CAM_FUNC_PARA1, 11, sGenericModePushPullVals0 },     // CAM_MODE_PUSHPULL
    { CAM_FUNC_KEEP1, 13, sGenericModeBoomFollowVals0 },   // CAM_MODE_BOOMFOLLLOW
...
CameraMode sCamSetTunnelModes[] = {
    { CAM_FUNC_NORM1, 10, sTunnelModeNormVals },           // CAM_MODE_NORMAL
    { CAM_FUNC_PARA1, 11, sGenericModeTargetVals0 },       // CAM_MODE_TARGET
    { CAM_FUNC_KEEP1, 13, sGenericModeFollowTargetVals0 }, // CAM_MODE_FOLLOWTARGET
    { CAM_FUNC_KEEP3, 12, sGenericModeTalkVals0 },         // CAM_MODE_TALK
    { CAM_FUNC_BATT1, 12, sGenericModeBattleVals0 },       // CAM_MODE_BATTLE
...
CameraMode sCamSetStairsModes[] = {
    { CAM_FUNC_NORM1, 10, sStairsModeNormVals },           // CAM_MODE_NORMAL
    { CAM_FUNC_PARA1, 11, sGenericModeTargetVals0 },       // CAM_MODE_TARGET
    { CAM_FUNC_KEEP1, 13, sGenericModeFollowTargetVals0 }, // CAM_MODE_FOLLOWTARGET
    { CAM_FUNC_KEEP3, 12, sGenericModeTalkVals0 },         // CAM_MODE_TALK
    { CAM_FUNC_BATT1, 12, sGenericModeBattleVals0 },       // CAM_MODE_BATTLE
...
// CAM_SET_SASA
CameraMode sCamSetSasaModes[] = {
    { CAM_FUNC_NORM1, 10, sSetSasaModeNormVals },          // CAM_MODE_NORMAL
    { CAM_FUNC_PARA1, 11, sGenericModeTargetVals0 },       // CAM_MODE_TARGET
    { CAM_FUNC_KEEP1, 13, sGenericModeFollowTargetVals0 }, // CAM_MODE_FOLLOWTARGET
    { CAM_FUNC_KEEP3, 12, sGenericModeTalkVals0 },         // CAM_MODE_TALK
...
CameraMode sCamSetDungeon0Modes[] = {
    { CAM_FUNC_NORM1, 10, sDungeon0ModeNormVals },       // CAM_MODE_NORMAL
    { CAM_FUNC_PARA1, 11, sGenericModeTargetVals1 },     // CAM_MODE_TARGET
...
CameraMode sCamSetDungeon1Modes[] = {
    { CAM_FUNC_NORM1, 10, sDungeon1ModeNormVals },         // CAM_MODE_NORMAL
    { CAM_FUNC_PARA1, 11, sDungeon1ModeTargetVals },       // CAM_MODE_TARGET
    { CAM_FUNC_KEEP1, 13, sGenericModeFollowTargetVals1 }, // CAM_MODE_FOLLOWTARGET
...
CameraMode sCamSetHorse0Modes[] = {
    ...
    { CAM_FUNC_NORM3, 9, sSetHrse0ModeTargetVals }, // CAM_MODE_TARGET
...
CameraMode sCamSetTower0Modes[] = {
    { CAM_FUNC_NORM2, 9, sTower0ModeNormVals },            // CAM_MODE_NORMAL
    { CAM_FUNC_PARA1, 11, sGenericModeTargetVals0 },       // CAM_MODE_TARGET
    { CAM_FUNC_KEEP1, 13, sGenericModeFollowTargetVals0 }, // CAM_MODE_FOLLOWTARGET
    { CAM_FUNC_KEEP3, 12, sGenericModeTalkVals0 },         // CAM_MODE_TALK
    { CAM_FUNC_BATT1, 12, sGenericModeBattleVals0 },       // CAM_MODE_BATTLE
    ...
    { CAM_FUNC_SUBJ3, 9, sGenericModeSlingshotVals0 },     // CAM_MODE_SLINGSHOT
    { CAM_FUNC_JUMP2, 9, sGenericModeClimbZVals0 },        // CAM_MODE_CLIMBZ
    { CAM_FUNC_NORM2, 9, sTower0ModeJumpVals },            // CAM_MODE_JUMP
    { CAM_FUNC_UNIQ1, 7, sGenericModeHangVals0 },          // CAM_MODE_HANG
    { CAM_FUNC_UNIQ1, 7, sGenericModeHangZVals0 },         // CAM_MODE_HANGZ
    { CAM_FUNC_JUMP1, 8, sGenericModeJumpVals0 },          // CAM_MODE_FREEFALL
    { CAM_FUNC_BATT4, 7, sGenericModeChargeVals0 },        // CAM_MODE_CHARGE
...
CameraMode sCamSetCirc3Modes[] = {
    ...
    { CAM_FUNC_SUBJ3, 9, sGenericModeBowVals0 },           // CAM_MODE_BOWARROW
    { CAM_FUNC_SUBJ3, 9, sGenericModeBowZVals0 },          // CAM_MODE_BOWARROWZ
    { CAM_FUNC_SPEC5, 8, sGenericModeHookshotVals1 },      // CAM_MODE_BOWARROWZ
    { CAM_FUNC_SUBJ3, 9, sGenericModeBoomerangVals0 },     // CAM_MODE_BOOMERANG
    { CAM_FUNC_SUBJ3, 9, sGenericModeSlingshotVals0 },     // CAM_MODE_SLINGSHOT
    { CAM_FUNC_JUMP2, 9, sGenericModeClimbZVals0 },        // CAM_MODE_CLIMBZ
...
CameraMode sCamSetItem0Modes[] = {
    { CAM_FUNC_DEMO3, 9, D_8011B730 }, // CAM_MODE_NORMAL
};
...
CameraMode sCamSetCirc7Modes[] = {
    ...
    { CAM_FUNC_SUBJ3, 9, sGenericModeBowVals0 },       // CAM_MODE_BOWARROW
    { CAM_FUNC_NONE, 0, NULL },                        // CAM_MODE_BOWARROWZ
    { CAM_FUNC_SPEC5, 8, sGenericModeHookshotVals1 },  // CAM_MODE_BOOMERANG
    { CAM_FUNC_SUBJ3, 9, sGenericModeBoomerangVals0 }, // CAM_MODE_BOOMERANG
    { CAM_FUNC_SUBJ3, 9, sGenericModeSlingshotVals0 }, // CAM_MODE_SLINGSHOT
};
...
CameraSetting sCameraSettings[] = {
    ...
    { { 0x051FFFFF }, sCamSetNorm0Modes },      // CAM_SET_NORMAL1
    { { 0x051FFFFF }, sCamSetDungeon0Modes },   // CAM_SET_DUNGEON0
    { { 0x051FFFFF }, sCamSetDungeon1Modes },   // CAM_SET_DUNGEON1
    { { 0x051FFFFF }, sCamSetNorm3Modes },      // CAM_SET_NORMAL3
    { { 0x8500018F }, sCamSetHorse0Modes },     // CAM_SET_HORSE0
    { { 0x051FFFFF }, sCamSetNorm5Modes },      // CAM_SET_NORMAL5      // CAM_SET_BOSS_GOMA
    { { 0x051FFFFF }, sCamSetNorm6Modes },      // CAM_SET_NORMAL6      // CAM_SET_BOSS_DODO
    { { 0x051FFFFF }, sCamSetNorm7Modes },      // CAM_SET_NORMAL7      // CAM_SET_BOSS_BARI
    { { 0x051FFFFF }, sCamSetNaviModes },       // CAM_SET_NAVI       // CAM_SET_BOSS_FGANON
    { { 0x051FFFFF }, sCamSetWaterModes },      // CAM_SET_WATER        // CAM_SET_BOSS_BAL
    { { 0x051FFFFF }, sCamSetLookUpModes },     // CAM_SET_LOOKUP       // CAM_SET_BOSS_SHADES
    { { 0x051FFFFF }, sCamSetBridgeModes },     // CAM_SET_BRIDGE       // CAM_SET_BOSS_MOFA
    { { 0x051FFFFF }, sCamSetTunnelModes },     // CAM_SET_TUNNEL       // CAM_SET_TWIN0
    { { 0x051FFFFF }, sCamSetStairsModes },     // CAM_SET_STAIRS       // CAM_SET_TWIN1
    { { 0x051FFFFF }, sCamSetSasaModes },       // CAM_SET_SASA         // CAM_SET_BOSS_GANON1
    ...
    { { 0x8C00000D }, sCamSetCirc3Modes },      // CAM_SET_CIRCLE3
    ...
    { { 0x4A000001 }, sCamSetItem0Modes },      // CAM_SET_ITEM0
    ...
    { { 0x051FFFFF }, sCamSetNorm0Modes },      // CAM_SET_NORMAL2
...
// Fire Temple Actors Start Cam Positions
Vec3f D_8011DA6C[] = { { 3050.0f, 700.0f, 0.0f },     // Pushblock Lift
                       { 1755.0f, 3415.0f, -380.0f }, // Hookshot Lift
                       { -3120.0f, 3160.0f, 245.0f }, // Elevator Lift
                       { 0.0f, -10.0f, 240.0f } };

// Fire Temple Actors End Cam Positions
Vec3f D_8011DA9C[] = {
    { 2880.0f, 1900.0f, 0.0f },    // Pushblock Lift
    { 1870.0f, 4150.0f, -825.0f }, // Hookshot Lift
    { -2520.0f, 4135.0f, 50.0f },  // Elevator Lift
    { -50.0f, 600.0f, -75.0f },
};
