...
ActorOverlay gActorOverlayTable[] = {
    ...
    ACTOR_OVERLAY(En_Slim, ALLOCTYPE_NORMAL),
    ACTOR_OVERLAY_UNSET,
    ...
    ACTOR_OVERLAY(Field_Keep, ALLOCTYPE_NORMAL),
    ACTOR_OVERLAY(En_Insect, ALLOCTYPE_NORMAL),
    ACTOR_OVERLAY(En_Fish, ALLOCTYPE_NORMAL),
    ACTOR_OVERLAY(Dungeon_Keep, ALLOCTYPE_NORMAL),
    ...
    ACTOR_OVERLAY(En_Npc, ALLOCTYPE_NORMAL),
    ...
    ACTOR_OVERLAY(Magic_Ice, ALLOCTYPE_ABSOLUTE),
    ...
    ACTOR_OVERLAY(Magic_Light, ALLOCTYPE_ABSOLUTE),
    ACTOR_OVERLAY(Magic_Soul, ALLOCTYPE_ABSOLUTE),
    ...
    ACTOR_OVERLAY(Arrow_Dark, ALLOCTYPE_ABSOLUTE),
    ...
    ACTOR_OVERLAY(Arrow_Soul, ALLOCTYPE_ABSOLUTE),
    ACTOR_OVERLAY(Arrow_Wind, ALLOCTYPE_ABSOLUTE),
    ...
    ACTOR_OVERLAY(Green_Cube, ALLOCTYPE_NORMAL),
