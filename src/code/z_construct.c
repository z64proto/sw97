...
void func_801109B0(GlobalContext* globalCtx) {
    ...
    R_ITEM_BTN_X(0) = 196; // 194;
    R_B_BTN_COLOR(0) = 90;
    R_B_BTN_COLOR(1) = 90;
    R_B_BTN_COLOR(2) = 255;
    R_ITEM_ICON_X(0) = 196; // 194;
    R_ITEM_AMMO_X(0) = 198; // 196;
    R_A_BTN_X = 158;        // 155;
    R_A_ICON_X = 158;       // 155;
    R_A_BTN_COLOR(0) = 0;
    R_A_BTN_COLOR(1) = 150;
...
void func_80111070(void) {
    ...
    XREG(62) = 0;
    XREG(63) = 0x64;
    XREG(64) = 253;  // textbox end marker X pos
    XREG(65) = 102;  // textbox end marker Y offset
    XREG(66) = 88;   // textbox choice selector x pos
    XREG(67) = 0x36; // textbox choice selector option 1 y pos
    XREG(68) = 0x46; // textbox choice selector option 2 y pos
    XREG(69) = 0x56; // textbox choice selector option 3 y pos
    XREG(70) = -0x12C;
    XREG(71) = 0;
    XREG(72) = 0x36;
    XREG(73) = 25;
    ...
    WREG(3) = 0x248B;
    WREG(4) = 8;
    WREG(5) = 6; // a Button rotation speed divisor
    WREG(6) = 8;
    WREG(7) = 0;
    WREG(8) = 0x64;
    WREG(9) = 0x6D;
    ...
    if (gSaveContext.gameMode == 0) {
        ...
        R_MINIMAP_COLOR(0) = 170;
        R_MINIMAP_COLOR(1) = 190;
