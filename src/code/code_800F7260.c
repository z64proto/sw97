...
u8 gPitchSound = false;

// when using this function you MUST make sure that there is an entry for a given sfx id in func_800F3A08
void Audio_PlaySoundPitched(u16 sxfId) {
    gPitchSound = true;
    Audio_PlaySoundGeneral(sxfId, &D_801333D4, 4, &D_801333E0, &D_801333E0, &D_801333E8);
}
