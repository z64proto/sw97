...
static CutsceneCameraPoint D_8012013C[14] = {
    { CS_CMD_CONTINUE, 25, 40, 70.79991f, { -1717, 533, -2266 } },
    { CS_CMD_CONTINUE, 20, 40, 70.99991f, { -1713, 434, -2275 } },
    { CS_CMD_CONTINUE, 10, 30, 60.0f, { -1700, 323, -2286 } },
    { CS_CMD_CONTINUE, 5, 25, 60.0f, { -1690, 218, -2263 } },
    { CS_CMD_CONTINUE, 3, 20, 60.0f, { -1663, 168, -2244 } },
    { CS_CMD_CONTINUE, 0, 20, 60.0f, { -1613, 115, -2175 } },
    { CS_CMD_CONTINUE, 0, 30, 55.0f, { -1632, 58, -2111 } },
    { CS_CMD_CONTINUE, 0, 30, 55.0f, { -1584, 31, -2111 } },
    { CS_CMD_CONTINUE, 0, 30, 60.0f, { -1629, 54, -2111 } },
    { CS_CMD_CONTINUE, 0, 30, 60.0f, { -1626, 35, -2107 } },
    { CS_CMD_CONTINUE, 0, 50, 60.0f, { -1599, 12, -2106 } },
    { CS_CMD_CONTINUE, 0, 50, 60.0f, { -1599, 12, -2106 } },
    { CS_CMD_STOP, 0, 50, 60.0f, { -1599, 12, -2106 } },
    { CS_CMD_STOP, 0, 30, 60.0f, { -1599, 12, -2106 } },
};
static CutsceneCameraPoint D_8012021C[14] = {
    { CS_CMD_CONTINUE, 0, 0, 60.0f, { -1653, 604, -2329 } }, { CS_CMD_CONTINUE, 0, 0, 60.0f, { -1653, 516, -2328 } },
    { CS_CMD_CONTINUE, 0, 0, 60.0f, { -1653, 417, -2329 } }, { CS_CMD_CONTINUE, 0, 0, 60.0f, { -1639, 306, -2313 } },
    { CS_CMD_CONTINUE, 0, 0, 60.0f, { -1625, 257, -2304 } }, { CS_CMD_CONTINUE, 0, 0, 60.0f, { -1569, 147, -2199 } },
    { CS_CMD_CONTINUE, 0, 0, 60.0f, { -1497, 72, -2111 } },  { CS_CMD_CONTINUE, 0, 0, 60.0f, { -1468, 7, -2111 } },
    { CS_CMD_CONTINUE, 0, 0, 60.0f, { -1450, 1, -2111 } },   { CS_CMD_CONTINUE, 0, 0, 60.0f, { -1496, 17, -2093 } },
    { CS_CMD_CONTINUE, 0, 0, 60.0f, { -1424, 10, -2073 } },  { CS_CMD_CONTINUE, 0, 0, 60.0f, { -1424, 10, -2073 } },
    { CS_CMD_STOP, 0, 0, 60.0f, { -1424, 10, -2073 } },      { CS_CMD_STOP, 0, 0, 60.0f, { -1424, 10, -2073 } },
};
...
static OnePointCsFull D_8012151C[2] = {
    { 0x0F, 0x01, 0x0101, 29, 0, 60.0f, 1.0f, { 1043.0f, 120.0f, -1073.0f }, { 1118.0f, 270.0f, -543.0f } },
    { 0x12, 0xFF, 0x0000, 1, 0, 60.0f, 1.0f, { -1.0f, -1.0f, -1.0f }, { -1.0f, -1.0f, -1.0f } },
};
...
static OnePointCsFull D_801218B4[2] = {
    { 0x0F, 0xFF, 0x0101, 60, 0, 65.0f, 1.0f, { 1.0f, 400.0f, -3029.0f }, { 0.0f, 620.0f, -2380.0f } },
    { 0x03, 0xFF, 0x0101, 100, 0, 70.0f, 0.02f, { 0.0f, 224.0f, -2917.0f }, { 0.0f, 264.0f, -2657.0f } },
};
