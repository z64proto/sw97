...
void EnDekubaba_SetupDecideLunge(EnDekubaba* this) {
    ...
    // spaceworld addition to make them vulnerable again after they hit you or have been deflected
    this->collider.base.colType = COLTYPE_HIT6;
...
void EnDekubaba_SetupLunge(EnDekubaba* this) {
    ...
    this->timer = 0;
    // spaceworld addition, makes them invincible during attacking
    this->collider.base.colType = COLTYPE_HARD;
...
void EnDekubaba_SetupPullBack(EnDekubaba* this) {
    ...
    this->timer = 0;
    // spaceworld addition, makes them vulnerable again after attack
    this->collider.base.colType = COLTYPE_HIT6;
...
void EnDekubaba_UpdateDamage(EnDekubaba* this, GlobalContext* globalCtx) {
    ...
    if (this->actor.colChkInfo.health != 0) {
        ...
        // remove finishing blow for spaceworld
...
void EnDekubaba_DrawBaseShadow(EnDekubaba* this, GlobalContext* globalCtx) {
    ...
    horizontalScale = this->size * 0.05f; // spaceworld change: tiny shadow
