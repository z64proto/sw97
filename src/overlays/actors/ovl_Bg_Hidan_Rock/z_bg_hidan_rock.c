...
static Vec3f D_8088BF60 = { 2760.0f, 120.0f, 0.0f }; // coord changed for spaceworld
...
static InitChainEntry sInitChain[] = {
    ICHAIN_VEC3F_DIV1000(scale, 65, ICHAIN_CONTINUE), // reduced scale
...
void BgHidanRock_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    this->dyna.actor.shape.rot.y += 0x8000; // needs to face the other way for Spaceworld
...
void func_8088B990(BgHidanRock* this, GlobalContext* globalCtx) {
    ...
    if ((this->type == 0 && (Math_SmoothStepToF(&this->dyna.actor.world.pos.y, 1720.0f, // reduced for spaceworld
