...
extern FlexSkeletonHeader D_0600F5D8;           // old model
extern FlexSkeletonHeader gSWZL1ChildZeldaSkel; // new model
...
extern u64 gSWZL1ChildZeldaEyeOpenTex[];
extern u64 gSWZL1ChildZeldaEyeBlinkTex[];
extern u64 gSWZL1ChildZeldaEyeShutTex[];
extern u64 gSWZL1ChildZeldaEyeWideTex[];
extern u64 gSWZL1ChildZeldaEyeSquintTex[];
extern u64 gSWZL1ChildZeldaEyeOutTex[];
extern u64 gSWZL1ChildZeldaEyeInTex[];
...
void EnZl1_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    SkelAnime_InitFlex(globalCtx, &this->skelAnime, &gSWZL1ChildZeldaSkel, NULL, NULL, NULL, 0);
    ...
    if (1) { // Spaceworld... just have Zelda idle instead of starting thru the window
...
void EnZl1_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    // set left eye
    gSPSegment(POLY_OPA_DISP++, 0x08, SEGMENTED_TO_VIRTUAL(gSWZL1ChildZeldaEyeOpenTex));
    // set right eye
    gSPSegment(POLY_OPA_DISP++, 0x09, SEGMENTED_TO_VIRTUAL(gSWZL1ChildZeldaEyeOpenTex));
    // set mouth
    gSPSegment(POLY_OPA_DISP++, 0x0A, SEGMENTED_TO_VIRTUAL(0x06009048));
