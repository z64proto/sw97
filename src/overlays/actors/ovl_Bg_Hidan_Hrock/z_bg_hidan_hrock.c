...
// Unused spaceworld addition
// #include "z_bg_hidan_hrock_gfx.c"

#define FLAGS 0x08000001 // changed for Navi target
...
void BgHidanHrock_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    thisx->flags |= 0x30;
    thisx->uncullZoneForward = 3000.0f;
    // spaceworld addition to set focus position for Navi target
    thisx->focus.pos.y = this->dyna.actor.world.pos.y + 20;
    //}
