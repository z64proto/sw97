...
static s16 sScenes[] = {
    SCENE_DEKU_TREE,    SCENE_DODONGOS_CAVERN, SCENE_FOREST_TEMPLE, SCENE_FIRE_TEMPLE, SCENE_WATER_TEMPLE, -1, -1,
    SCENE_OLD_TESTROOM, SCENE_SPECIAL_COURSE,
};
