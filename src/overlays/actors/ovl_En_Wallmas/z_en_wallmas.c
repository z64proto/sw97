...
void EnWallmas_SetupLand(EnWallmas* this, GlobalContext* globalCtx) {
    AnimationHeader* objSegFrameCount = &gWallmasterFJumpAnim;
    AnimationHeader* objSegChangee = &gWallmasterFJumpAnim;
...
void EnWallmas_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->actionFunc != EnWallmas_WaitToDrop) {
        ...
        SkelAnime_DrawOpa(globalCtx, this->skelAnime.skeleton, this->skelAnime.jointTable, EnWallMas_OverrideLimbDraw,
                          NULL, this);
    }
