...
void MagicDark_DiamondUpdate(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (nayrusLoveTimer >= 1200) {
        ...
        gSaveContext.nayrusLoveTimer = 0;
        MagicDark_DimLighting(globalCtx, 0);
        Actor_Kill(thisx);
        return;
    }
    ...
    if (nayrusLoveTimer < 1100) {
        MagicDark_DimLighting(globalCtx, 1.0f);
        Audio_PlaySoundGeneral(NA_SE_EV_FANTOM_WARP_L - SFX_FLAG, &D_801333D4, 4, &D_801333E0, &sfxLowerVolume,
                               &D_801333E8);
    } else {
        MagicDark_DimLighting(globalCtx, -0.0075f * (-1199.0f + nayrusLoveTimer));
        Audio_PlaySoundGeneral(NA_SE_EV_FANTOM_WARP_S - SFX_FLAG, &D_801333D4, 4, &D_801333E0, &sfxLowerVolume,
                               &D_801333E8);
    }
}
