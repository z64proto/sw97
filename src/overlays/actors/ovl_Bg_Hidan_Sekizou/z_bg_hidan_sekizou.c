...
void BgHidanSekizou_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    } else { // short and tall four-way flamethrower tower
...
Gfx* func_8088D9F4(GlobalContext* globalCtx, BgHidanSekizou* this, s16 arg2, MtxF* arg3, f32 arg4, f32 arg5, s16 arg6,
    ...
    arg3->wx = (temp_f2 * arg4) + this->dyna.actor.world.pos.x;
    arg3->wy = this->dyna.actor.world.pos.y + 30.0f + (.7f * phi_f12);
    arg3->wz = (temp_f2 * arg5) + this->dyna.actor.world.pos.z;
    gSPMatrix(arg7++,
...
Gfx* func_8088DC50(GlobalContext* globalCtx, BgHidanSekizou* this, s16 arg2, s16 arg3, Gfx* arg4) {
    ...
    temp_v1 = Camera_GetCamDirYaw(ACTIVE_CAM) - arg2;
...
void BgHidanSekizou_Draw(Actor* thisx, GlobalContext* globalCtx2) {
    ...
    switch (this->dyna.actor.params) {
            case 0:
                // small two-way flamethrower
                gSPDisplayList(POLY_OPA_DISP++, gFireTempleStationaryFlamethrowerShortDL);
                break;
            case 1:
                // short four-way flamethrower tower
                gSPDisplayList(POLY_OPA_DISP++, gBetaFireTempleStationaryFlamethrower);
                break;
            case 2:
                // tall four-way flamethrower tower
    ...
    if (this->dyna.actor.params == 0) {
        if (this->unk_168[0] > 0) {
            if ((s16)(Camera_GetCamDirYaw(ACTIVE_CAM) - this->dyna.actor.shape.rot.y) >= 0) {
        ...
        func_8088DE08(Camera_GetCamDirYaw(ACTIVE_CAM), this->dyna.actor.shape.rot.y, sp6C);
        for (i = 0; i < 4; i++) {
            s32 index = sp6C[i];
