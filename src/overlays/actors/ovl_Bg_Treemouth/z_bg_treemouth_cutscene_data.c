...
CutsceneData D_808BD520[] = {
    ...
    CS_CAM_POS_LIST(0, 1151),
        CS_CAM_POS(CS_CMD_CONTINUE, 0x00, 0, 60.0f, 2573, 47, -313, 0x00EA),
        CS_CAM_POS(CS_CMD_CONTINUE, 0x00, 0, 40.999928f, 2573, 47, -313, 0x00FB),
        CS_CAM_POS(CS_CMD_CONTINUE, 0x00, 0, 40.999928f, 2573, 47, -313, 0x010C),
        CS_CAM_POS(CS_CMD_CONTINUE, 0x00, 0, 40.999928f, 2573, 47, -313, 0x0198),
        CS_CAM_POS(CS_CMD_CONTINUE, 0x00, 0, 40.999928f, 2573, 47, -313, 0x019A),
        CS_CAM_POS(CS_CMD_CONTINUE, 0x00, 0, 40.999928f, 2573, 47, -313, 0x01AB),
        CS_CAM_POS(CS_CMD_STOP, 0x00, 0, 40.999928f, 2573, 47, -313, 0x01BC),
    CS_CAM_FOCUS_POINT_LIST(0, 1180),
        CS_CAM_FOCUS_POINT(CS_CMD_CONTINUE, 0x00, 30, 40.999928f, 2661, 60, -376, 0x00EA),
        CS_CAM_FOCUS_POINT(CS_CMD_CONTINUE, 0x00, 30, 40.999928f, 2661, 60, -376, 0x00FB),
        CS_CAM_FOCUS_POINT(CS_CMD_CONTINUE, 0x00, 30, 40.999928f, 2661, 60, -376, 0x010C),
        CS_CAM_FOCUS_POINT(CS_CMD_CONTINUE, 0x00, 30, 40.999928f, 2661, 60, -376, 0x0198),
        CS_CAM_FOCUS_POINT(CS_CMD_CONTINUE, 0x00, 1000, 40.999928f, 2661, 60, -376, 0x019A),
        CS_CAM_FOCUS_POINT(CS_CMD_CONTINUE, 0x00, 30, 40.999928f, 2661, 60, -376, 0x01AB),
        CS_CAM_FOCUS_POINT(CS_CMD_STOP, 0x00, 30, 40.999928f, 2661, 60, -376, 0x01BC),
    CS_TEXT_LIST(1),
        //CS_TEXT_NONE(0, 20),
