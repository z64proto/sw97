...
#define MAXCIRCLERADIUS 80.0f //how far from link to circle
#define MINCIRCLERADIUS 20.0f //how close to link to circle before backing away from him
#define BOBSPEED 25 //how quick to go up and down
#define BOBHEIGHT 150 //how high to go up (down is level)
...
typedef struct EnNiw {
    ...
    /* 0x0??? */ s16 circleTargetYaw; //added for spaceworld
    /* 0x0??? */ Vec3s headTarget; //added for spaceworld
    /* 0x???? */ s16 bob; //added for spaceworld
    /* 0x???? */ s16 bobamount; //added for spaceworld
} EnNiw; // size = something greater than it was before
