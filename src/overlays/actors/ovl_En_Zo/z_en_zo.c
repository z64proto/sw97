...
void EnZo_SetAnimation(EnZo* this) {
    ...
    if (this->npcInfo.talkState != 0 && this->actor.textId == 0x4006 && this->skelAnime.animation != &D_06000598) {
        animId = 6;
    }

    if (this->npcInfo.talkState != 0 && this->actor.textId == 0x4007 && this->skelAnime.animation != &D_06000D48) {
        animId = 7;
    }
