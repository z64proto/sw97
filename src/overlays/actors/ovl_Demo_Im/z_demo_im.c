...
// textures
// spaceworld didn't have animated eyes though
...
extern AnimationHeader object_im_Anim_000710;
extern AnimationHeader object_im_Anim_000AFC;
extern AnimationHeader object_im_Anim_0014E4;
extern AnimationHeader object_im_Anim_001868;
extern AnimationHeader object_im_Anim_00FB10;
extern AnimationHeader object_im_Anim_0101C8;
extern AnimationHeader object_im_Anim_010EE0;
extern AnimationHeader object_im_Anim_01182C;
extern AnimationHeader object_im_Anim_011C08;
extern AnimationHeader object_im_Anim_012218;
...
void func_80986D40(DemoIm* this, GlobalContext* globalCtx) {
    if (gSaveContext.sceneSetupIndex == 6) {
        this->action = 19;
        this->drawConfig = 1;
    } else if (false && gSaveContext.eventChkInf[8] & 1) { // spaceworld
        Actor_Kill(&this->actor);
    } else if (false && !(gSaveContext.eventChkInf[5] & 0x200)) { // spaceworld
        this->action = 23;
    } else {
        this->action = 20;
    }
...
void DemoIm_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    SkelAnime_InitFlex(globalCtx, &this->skelAnime, &gSWImpaSkel, NULL, this->jointTable, this->morphTable, 16);
    thisx->flags &= ~1;
