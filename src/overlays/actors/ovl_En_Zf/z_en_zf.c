...
s16 func_80B44870(Vec3f* pos, s16 arg1, s16 arg2, GlobalContext* globalCtx) {
    ...
    for (; loopIndex >= minIndex; loopIndex--) {
        ...
        if (((temp_s3 == -1) && (Math_Vec3f_DistXYZ(&player->actor.world.pos, &D_80B4A090[loopIndex]) < phi_f26))) {
            continue;
        }
        temp_f0 = Math_Vec3f_DistXYZ(pos, &D_80B4A090[loopIndex]);
...
void func_80B45174(EnZf* this, GlobalContext* globalCtx) {
    if (this->unk_3F0 == 1) {
        ...
        // no miniboss music in spaceworld
        // if (this->actor.params == 0) {
        //     func_800F5ACC(0x38);
        // }
    }
    ...
    if ((this->actor.bgCheckFlags & 3) && (this->unk_3E4 != 0)) {
        ...
        Actor_SpawnFloorDust(globalCtx, &this->actor, &this->unk_4F0, 3.0f, 2, 2.0f, 0, 0, 0);
        Actor_SpawnFloorDust(globalCtx, &this->actor, &this->unk_4E4, 3.0f, 2, 2.0f, 0, 0, 0);
    }
...
void func_80B46AE0(EnZf* this, GlobalContext* globalCtx) {
    ...
    if (SkelAnime_Update(&this->skelAnime)) {
        ...
        if ((this->actor.params == -2) && (Actor_IsFacingPlayer(&this->actor, 5460) == 0)) {
            func_80B45384(this);
        ...
        case 0:
            ...
            switch (temp_v1_2) {
                ...
                default:
                    ...
                    for (phi_v1 = 0x14; phi_v1 >= 0; phi_v1--, phi_f20_2 += 10.0f, phi_f0 += 1.2f) {
...
void EnZf_Draw(Actor* thisx, GlobalContext* globalCtx) {
    s32 pad;
    EnZf* this = THIS;
    ; // Extra ";" required for matching. Cannot be  or the like. Probably a typo.
...
s32 func_80B49C2C(GlobalContext* globalCtx, EnZf* this) {
    ...
    temp_actor = Actor_GetProjectileActor(globalCtx, &this->actor, 600.0f);
