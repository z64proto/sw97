...
void Title_PrintBuildInfo(Gfx** gfxp) {
    ...
    GfxPrint_Printf(printer, "SPACE WORLD VERSION");
...
void Title_Draw(TitleContext* this) {
    ...
    static Lights1 titleLights = gdSPDefLights1(255, 255, 255, 255, 255, 255, 69, 69, 69);
    u16 y;
    u16 idx;
    s32 pad1;
    Vec3f v3;
    ...
    gSPSetLights1(POLY_OPA_DISP++, titleLights);
    Title_SetupView(this, 0.0f, 150.0f, 300.0f);
    ...
    gSPDisplayList(POLY_OPA_DISP++, &gN64LogoCubeDL);
    ...
    gDPLoadMultiBlock(POLY_OPA_DISP++, &gN64CubeSurface1Tex, 0x100, 1, G_IM_FMT_I, G_IM_SIZ_8b, 32, 32, 0,
                      G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 5, 2, 11);

    for (idx = 0, y = 94; idx < 16; idx++, y += 2) {
        gDPLoadTextureBlock(POLY_OPA_DISP++, (u8*)gN64LogoTextTex + ((192 * 2) * idx), G_IM_FMT_I, G_IM_SIZ_8b, 192, 2,
