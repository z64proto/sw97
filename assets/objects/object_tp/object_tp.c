...
static Vtx object_tpVtx_000070[98];
...
Gfx gTailpasaranTailSegmentDL[] = {
    ...
    gsSPVertex(&object_tpVtx_000070[0], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
}; 

static Vtx object_tpVtx_000070[] = {
...
u64 gTailpasaranHeadRearTex[] = {
    #include "assets/objects/object_tp/tailpasaran_head_rear.rgb5a1.inc.c"
};

u64 gTailpasaranHeadClawBaseTex[] = {
    #include "assets/objects/object_tp/tailpasaran_head_claw_base.rgb5a1.inc.c"
};

u64 gTailpasaranHeadClawTex[] = {
    #include "assets/objects/object_tp/tailpasaran_head_claw.rgb5a1.inc.c"
};
...
u64 gTailpasaranHeadMouthpartsTex[] = {
    #include "assets/objects/object_tp/tailpasaran_head_mouthparts.rgb5a1.inc.c"
};

static u8 possiblePadding_001CE8[8] = {
