...
static Vtx object_efc_fire_ballVtx_000000[4];

static Vtx object_efc_fire_ballVtx_000000[4] = {
    VTX(-1000, -1000, 0, 0, 1024, 0, 0, 120, 255),
    VTX(1000, -1000, 0, 1024, 1024, 0, 0, 120, 255),
    VTX(1000, 1000, 0, 1024, 0, 0, 0, 120, 255),
...
Gfx gCreationFireBallDL[] = {
    ...
    gsSPVertex(&object_efc_fire_ballVtx_000000[0], 4, 0),
