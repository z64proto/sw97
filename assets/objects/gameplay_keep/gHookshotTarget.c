...
static Vtx object_d_hsblockVtx_000100[17] = {
    VTX(-200, 1000, -200, -UVa, -UVa, 255, 255, 255, 255),
    VTX(-200, 1000, 200, -UVa, UVb, 255, 255, 255, 255),
    VTX(200, 1000, 200, UVb, UVb, 255, 255, 255, 255),
    VTX(200, 1000, -200, UVb, -UVa, 255, 255, 255, 255),
...
Gfx gHsBlockDL_000210[] = {
    ...
    gsDPPipeSync(),
    gsDPLoadTextureBlock(gUnusedStoneHookshotTargetTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_MIRROR | G_TX_WRAP, G_TX_MIRROR
